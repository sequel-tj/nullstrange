...
const youtubeDatas = [
  ...
  {
    title:
      "Pata Nahi Kis Roop Mai Aakar Narayan Mil Jayega (LoFi REMIX) | Ram Darshan | Narci | Hindi Rap Song",
  ...
  {
    title:
      "Pyar Hame Kis Mod Pe Le Aaya | TRAP REMIX | Kishore Kumar | NullStrange",
  ...
  {
    title:
      "HAAL KYA HAI DILON KA NA PUCHO SANAM (Remix) |  हाल क्या है दिलों | Kishore Kumar | Anokhi Ada",
      ...
      <Carousel autoplay>
        <div>
          <div style={contentStyle}>
            <iframe
              style={embedVideoCarousel}
              title={youtubeDatas[0].title}
              src={youtubeDatas[0].videoURL}
        ...
        <div>
          <div style={contentStyle}>
            <iframe
              style={embedVideoCarousel}
              title={youtubeDatas[1].title}
              src={youtubeDatas[1].videoURL}
              allow="accelerometer; picture-in-picture; web-share; allowfullscreen"
            ></iframe>
          </div>
        </div>
        <div>
          <div style={contentStyle}>
            <iframe
              style={embedVideoCarousel}
              title={youtubeDatas[2].title}
              src={youtubeDatas[2].videoURL}
              allow="accelerometer; picture-in-picture; web-share; allowfullscreen"
            ></iframe>
          </div>
        </div>
        <div>
          <div style={contentStyle}>
            <iframe
              style={embedVideoCarousel}
              title={youtubeDatas[3].title}
              src={youtubeDatas[3].videoURL}
              allow="accelerometer; picture-in-picture; web-share; allowfullscreen"
            ></iframe>
          </div>
        </div>
